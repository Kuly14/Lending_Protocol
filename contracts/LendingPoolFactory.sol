...
contract LendingPoolFactory is Ownable {
    ...
    function createPool(
        ...
        require(
            ...
            "Pool can't be for the zero address"
        );
        require(!checkIfPoolExists(_tokenAddress), "This pool already exists");
        LendingPoolErc20 pool = new LendingPoolErc20(
            _name,
            _symbol,
            _tokenAddress
        );
    ...
    function checkIfPoolExists(address _tokenAddress)
        internal
        view
        returns (bool)
    {
